...
class MockCurrentVolunteerAssociationProvider extends StateNotifier<CurrentAssociation?> implements CurrentAssociationNotifier {
  ...
  MockCurrentVolunteerAssociationProvider(super._state) {
    currentAssociation = CurrentAssociation(currentAssociation: volunteerAssociation, confirmed: false);
  }
...
final mockCurrentAssociationProvider = StateNotifierProvider<MockCurrentVolunteerAssociationProvider, CurrentAssociation?>((ref) {return MockCurrentVolunteerAssociationProvider(null);});
