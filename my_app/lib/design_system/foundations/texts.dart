...
class SerManosTexts extends Text {
  ...
  SerManosTexts.body1(super.text,
      {super.key,
      Color? color,
      super.textAlign,
      super.maxLines,
  ...
  SerManosTexts.body2(super.text,
      {super.key,
      Color? color,
      super.textAlign,
      super.maxLines,
  ...
  SerManosTexts.button(super.text,
      {super.key,
      Color? color,
      super.textAlign,
      super.maxLines,
  ...
  SerManosTexts.caption(super.text,
      {super.key,
      Color? color,
      super.textAlign,
      super.maxLines,
  ...
  SerManosTexts.overline(super.text,
      {super.key,
      Color? color,
      super.textAlign,
      super.maxLines,
