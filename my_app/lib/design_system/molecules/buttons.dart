...
class SerManosButton extends StatelessWidget {
  const SerManosButton(
      {super.key, required this.label, required this.onPressed, this.disabled = false, this.big = false});
...
class SerManosTextButton extends StatelessWidget {
  const SerManosTextButton({super.key, required this.label, required this.onPressed, this.disabled = false});
